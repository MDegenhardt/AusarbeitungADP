\documentclass[longdoc, bigchapter, colorbacktitle,accentcolor=tud1c,12pt, numbersubsubsec]{tudreport}
...
\title{Sensitivität numerischer Vorhersagen des Wirkungsgrads von Hoch\-druck\-tur\-binen}
...
\setinstitutionlogo[height]{glr_phaser_mit.eps}

%%% Untere Titelrückseite
\lowertitleback{%
	Keijo Buss, Dominik Henzel, Markus Degenhardt, Simon Lippert\\
	Studiengang: Computational Engineering M.Sc.\\ \\
	Thema: Sensitivität numerischer Vorhersagen des Wirkungsgrads von Hoch\-druck\-turbinen\\\\
...
\begin{document}
	...
	\include{vorgehen}
	\include{grundlagen} %Dominik Keijo eingefügt
